...
def create_agent(sess, environment, summary_writer=None):
  return rainbow_rgb_agent.RainbowAgent(
        sess, num_actions=5,
        summary_writer=summary_writer)


def create_fetch_cam_environment(is_render):
  env = FetchDiscreteCamEnv(dis_tolerance = 0.001, step_ds=0.005, gray_img = False, only_show_obj0=False, is_render=is_render)
  return env
